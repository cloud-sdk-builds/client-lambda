...
[`@aws-sdk/client-lambda`](https://www.npmjs.com/package/@aws-sdk/client-lambda/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lambda@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tAqlMysjaRtu4bsoJaEvDCiQu38EoZw8ypcYZX3k1BMoDttpdZddn1Xplkp2+f9Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lambda": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lambda@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lambda@3.112.0/index.min.mjs": "sha384-tAqlMysjaRtu4bsoJaEvDCiQu38EoZw8ypcYZX3k1BMoDttpdZddn1Xplkp2+f9Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lambda/blob/refs/tags/3.112.0/LICENSE
```
